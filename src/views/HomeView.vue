<template>
  <v-app id="inspire" :style="{ background: $vuetify.theme.themes.dark.background }">
    ...
    <v-container>
      <v-row>
        <v-col cols="12" sm="12">
          <v-card class="mx-auto rounded-xl" height="620px" elevation-2 color="grey darken-4">
            <v-row>
              <v-col cols="12" sm="12">
              ...
              <v-col cols="12" sm="8">
                ...
                <v-sparkline :value="value" :smooth="radius || false" :padding="padding" :line-width="width"
                  :stroke-linecap="lineCap" :fill="fill" :type="type" :auto-line-width="autoLineWidth" auto-draw
                  color="white"></v-sparkline>
